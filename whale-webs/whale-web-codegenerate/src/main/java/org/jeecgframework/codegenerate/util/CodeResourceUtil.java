 ...
 {
   private static final ResourceBundle bundle = ResourceBundle.getBundle("generate_database");
   private static final ResourceBundle bundlePath = ResourceBundle.getBundle("generate_config");
   ...
   static
   {
     ...
     JSPPATH = web_root_package + "/" + "templates" + "/";
   }
