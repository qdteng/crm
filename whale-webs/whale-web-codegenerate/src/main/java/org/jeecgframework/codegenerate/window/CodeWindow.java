 ...
 */
   ...
   extends JFrame
 {
   ...
   String[] planets = {  "identity" }; //, "uuid", "sequence"
...
//         System.out.println("tablekeyfld.getSelectedItem ===="+(String)tablekeyfld.getSelectedItem());
 
         //CodeWindow.access$402();
...
//             CodeWindow.primaryKeyPolicy=sequence_fld.getText();
//           } else {
//             showlbl.setForeground(Color.red);
