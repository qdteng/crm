package cn.com.ylpw.web.crm.quarz.mapper;
...
public class BaseDao<T, PK extends Serializable> extends SqlSessionDaoSupport implements Serializable {  
    ...
    public int insert(T entity) {  
        return getSqlSession().insert( POSTFIX + entity.getClass().getSimpleName()+_MAPPER+ _INSERT, entity);  
    }  
      
      
    public int insertSelective(T record) {  
        return getSqlSession().insert(  
        		POSTFIX +record.getClass().getSimpleName()+_MAPPER+ _INSERTSELECTIVE, record);  
    }  
  
    public T selectByPrimaryKey(PK id,Class entity  ) {
        return getSqlSession().selectOne( POSTFIX+entity.getSimpleName()+ _MAPPER+ _SELECTBYPRIMARYKEY, id);  
    }  
  
      
    public int updateByPrimaryKey(T record ) {  
        return getSqlSession().update( POSTFIX +record.getClass().getSimpleName()+_MAPPER+ _UPDATEBYPRIMARYKEY, record);  
    }   
  
    public int updateByPrimaryKeySelective(T record) {  
        return getSqlSession().update(  
        		POSTFIX +record.getClass().getSimpleName()+ _MAPPER+_UPDATEBYPRIMARYKEYSELECTIVE, record);  
    }  
  
    public int deleteByPrimaryKey(PK id,Class entity) {  
        return getSqlSession().delete(  
        		POSTFIX+entity.getSimpleName() +_MAPPER+ _DELETEBYPRIMARYKEY, id);  
    }
    ...
    public <M> PageInfo<M> pageFindModel(String statementKey,  Page<Map<String,Object>> page , Object parameter,Class entity) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {  
        ...
        List<M> list = getSqlSession().selectList(POSTFIX+entity.getSimpleName()+_MAPPER+"."+statementKey, params);  
    ...
    public Object findOneObject(String mapperKey, Object  searchParam,Class entity)throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		return getSqlSession().selectOne(POSTFIX+entity.getSimpleName()+_MAPPER+"."+mapperKey, params);
	}
